...
- (UISegmentedControl *)segControl{
    if (_segControl == nil) {
        ...
        [_segControl setTitleTextAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:14.0],NSForegroundColorAttributeName:[UIColor whiteColor]} forState:UIControlStateNormal];
...
- (UIView *)titleView{
    if (_titleView == nil) {
        ...
        [_line mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.mas_equalTo(ws.segControl.mas_bottom).offset(1);
